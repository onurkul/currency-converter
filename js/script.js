...
function getExchangeRate() {
    ...
    exchangeRateTxt.innerText = "Döviz kuru verisi alınıyor...";
    let url = `https://v6.exchangerate-api.com/v6/01480dae83b49b674059b983latest/${fromCurrency.value}`;
    ...
    fetch(url).then(response => response.json()).then(result => {
        ...
        exchangeRateTxt.innerText = "Opss! Bir şeyler ters gitti!";
    });
}